...
loss(θ) = mse_loss(θ, y, predict)

# w1_ax = LinRange(-0.05, 0.05, 1001)
# w2_ax = LinRange(0.05, 0.15, 1001)
...
# s = surface(w1_ax, w2_ax, transformed_surface)
